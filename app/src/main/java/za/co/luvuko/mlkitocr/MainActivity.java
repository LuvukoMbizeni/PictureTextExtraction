...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChooseImage = (Button) findViewById(R.id.choose_image);
        btnspeechBtn = (Button) findViewById(R.id.speech);
        ...
        btnspeechBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
